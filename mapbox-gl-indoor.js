var mapboxgl_indoor = (function (exports, mapboxGl) {
	'use strict';
	...
	var distance_2 = distance_1.distance;
	...
	function filterWithLevel(initialFilter, level) {
	    return [
	        "all",
	        [
	            "has",
	...
	class Indoor {
	    ...
	    _updateFiltering() {
	        ...
	        let filterFn;
	        if (level !== null) {
	            filterFn = (filter) => filterWithLevel(filter, level);
	        }
	        else {
	    ...
	    closestMap() {
	        ...
	        for (const map of mapsInBounds) {
	            const _dist = distance_2(map.bounds.getCenter(), cameraBounds.getCenter());
	            if (_dist < minDist) {
	                closestMap = map;
	                minDist = _dist;
	            }
	...
	class GeoJsonHelper {
	    ...
	    static extractLevelsRangeAndBounds(geojson) {
	        ...
	        const bounds = mapboxGl.LngLatBounds.convert(bbox(geojson));
	...
	exports.IndoorControl = IndoorControl;
	exports.IndoorMap = IndoorMap;
	exports.IndoorStyle = Style;
